...
function TapeCamdenSite() {
  ...
  return <main className="site">
    ...
    <section className="gallery"><div className="wrap"><div className="galleryHeader"><div><p>Gallery</p><h2>Tape. Export. Send.</h2></div><Crown className="crown" size={64} /></div><div className="galleryGrid">{galleryItems.map((item, i) => <div key={item} className={`galleryTile tile${i % 3}`}><div className="tileDots" /><div className="tileLabel"><Play size={20} /><strong>{item}</strong></div></div>)}</div><p className="galleryNote">Replace these blocks with your real self tape videos, actor clips and studio stills.</p></div></section>
